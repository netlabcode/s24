...
val1 = client.get_node("ns=2;i=574")
val2 = client.get_node("ns=2;i=575")
val3 = client.get_node("ns=2;i=576")
val4 = client.get_node("ns=2;i=577")
val5 = client.get_node("ns=2;i=578")
val6 = client.get_node("ns=2;i=579")
