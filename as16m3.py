...
val1 = client.get_node("ns=2;i=586")
val2 = client.get_node("ns=2;i=587")
val3 = client.get_node("ns=2;i=588")
val4 = client.get_node("ns=2;i=589")
val5 = client.get_node("ns=2;i=590")
val6 = client.get_node("ns=2;i=591")
