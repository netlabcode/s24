...
val1 = client.get_node("ns=2;i=635")
val2 = client.get_node("ns=2;i=636")
val3 = client.get_node("ns=2;i=637")
val4 = client.get_node("ns=2;i=638")
val5 = client.get_node("ns=2;i=639")
val6 = client.get_node("ns=2;i=640")
